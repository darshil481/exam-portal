...
CREATE TABLE `result` (
  ...
  `student_name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `user_id` int DEFAULT NULL,
  `exam_id` int DEFAULT NULL,
  `obtained_marks` int DEFAULT NULL,
  `is_attempted` int DEFAULT NULL,
  `created_date` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`result_id`),
  KEY `user_id` (`user_id`),
  KEY `exam_id` (`exam_id`),
  CONSTRAINT `result_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_login` (`user_id`),
